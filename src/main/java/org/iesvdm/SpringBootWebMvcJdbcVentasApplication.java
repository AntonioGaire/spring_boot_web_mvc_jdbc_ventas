...
public class SpringBootWebMvcJdbcVentasApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente clienteNew = new Cliente(0, "Jose M", "Martín", null, "Málaga", 100, "email@email.es");
		...
		if (comercial.isPresent()) {
			...
			comercial.get().setNombre("Juan Modi");
		...
		// Como es un cliente nuevo a persistir, id a 0
		Comercial comercialNew = new Comercial(0, "Juan Modi", "modifi", null, (float)(0.225));
